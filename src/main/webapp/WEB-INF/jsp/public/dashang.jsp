...
<div class="shang_box">
	...
	<div class="shang_payimg">
		...
		<div class="pay_explain">你的打赏，就是他分享代码最大的动力<img alt="[嘻嘻]" title="[嘻嘻]" src="res/layui/images/face/01.gif"></div>
	...
	<div class="shang_info">
		<p>打开<span id="shang_pay_txt">微信</span>扫一扫，即可进行扫码赞助</p>
	</div>
</div>
...
$(function(){
	$(".pay_item").click(function(){
		...
		$(".shang_payimg img").attr("src","res/images/dashang/img/userpayimg/"+dataid+".jpg");
